...
export const chatMethodSchema = z.enum(["chat.snapshot", "chat.submit"]);
export type ChatMethod = z.infer<typeof chatMethodSchema>;
...
export function parseResult(method: ChatMethod, value: unknown): ChatSnapshot | SubmitResult {
  switch (method) {
    case "chat.snapshot":
