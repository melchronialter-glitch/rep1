...
- The v0.4.2 stale-submission lineage regression tests and `assembleDebug` pass in [GitHub Actions run 31823289760](https://github.com/melchronialter-glitch/rep1/actions/runs/31823289760). Its debug APK SHA-256 is `b714cc228fcac920ea5378c8ea25cb2eeaf8660f404b2f3fa06f6a43f9576c94`.
- The v0.4.3 asynchronous composer-verification tests and `assembleDebug` pass in [GitHub Actions run 31833534133](https://github.com/melchronialter-glitch/rep1/actions/runs/31833534133). Its debug APK SHA-256 is `0c73382fc23f3ed049d0572e743ba9ab4dc1b9f7b685426e6087c31b97d823e8`.
- Each verified APK is published as its workflow run's artifact; no prebuilt binary is tracked in this source package unless a file is explicitly present under `release/`.
